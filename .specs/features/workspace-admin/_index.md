...
| [linux-passwords.md](./linux-passwords.md) | Linux 密码库 CRUD、独立目录接口、登录态新增与 admin 编辑/删除 | 暂未纳入 OpenAPI 分册 |
...
| `linux-passwords.md` | [WorkspaceLinuxPasswordController.java](../../../src/main/java/com/support/server/supportrosterserver/controller/workspace/WorkspaceLinuxPasswordController.java) / [WorkspaceLinuxPasswordDirectoryController.java](../../../src/main/java/com/support/server/supportrosterserver/controller/workspace/WorkspaceLinuxPasswordDirectoryController.java) | [WorkspaceLinuxPasswordService.java](../../../src/main/java/com/support/server/supportrosterserver/service/workspace/WorkspaceLinuxPasswordService.java) | [WorkspaceLinuxPasswordDto.java](../../../src/main/java/com/support/server/supportrosterserver/dto/workspace/WorkspaceLinuxPasswordDto.java) / [WorkspaceLinuxPasswordUpsertRequest.java](../../../src/main/java/com/support/server/supportrosterserver/dto/workspace/WorkspaceLinuxPasswordUpsertRequest.java) |
